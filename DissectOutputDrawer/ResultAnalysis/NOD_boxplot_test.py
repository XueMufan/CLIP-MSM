...
place_index = [2, 0, 1, 3]
name_label: list = ['faces', 'bodies', 'places', 'words']
dissect_name_labels: list = ['Faces', 'Bodies', 'Places', 'Words']  
if __name__ == "__main__":
    ...
    new_labels = [each for each in name_label]
    ...
    for i, label in enumerate(labels):
        ...
        plt.ylim((0, 1))
    f3 = ax.boxplot(hard_data_numpy[0] - 100, positions=[3 * 1.5 + 0.3], widths=0.4, showfliers=False, patch_artist=True,
    ...
    f4 = ax.boxplot(hard_data_numpy[0] - 100, positions=[3 * 1.5 + 0.3], widths=0.4, showfliers=False, patch_artist=True,
    ...
    plt.savefig('NOD_boxplot.png', dpi=2080)
...
def make_volume(
    ...
    selevtive_roi = load_mask_from_nii(PPdataPath + '/subj0%d/func1pt8mm/roi/%s.nii.gz'%(subj,roi))
    selevtive_roi  = selevtive_roi[~np.isnan(selevtive_roi)]

    
    # selevtive_roi = selevtive_roi - 1
    val[roi_in_nsdgeneral_mask] = selevtive_roi[roi_to_nsdgeneral_index]
    val[val == 0] = np.nan
    vmin=0
    vmax=6

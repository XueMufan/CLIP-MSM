...
#             # 打印调试信息
#             print(f"Setting view with parameters: {params}")

#             # 替换subject
#             params = {k.format(subject=subject): v for k, v in params.items()}
...
# cm.register_cmap(name='custom_cmap', cmap=custom_cmap)


def save_3d_views1(data, root, base_name, list_views =['lateral'],list_surfaces = ['inflated'], with_labels = False,
    ...
    if with_labels:
        ...
        labels_visible=()
    cortex.quickshow(data, cmap='custom_cmap')

...
if __name__ == '__main__':
    ...
    parser.add_argument("--model", type=str, default="RN50_NOD")
    ...
    # this is for CLIP_ResNet

    featmat_coco=np.array(torch.load(ROOT + '/result/features/NOD/nod_coco_clip_resnet50_last_layer.pt'))
    featmat=torch.load(ROOT + '/result/features/NOD/nod_sub%02d_clip_resnet50_last_layer.pt' % subj)
